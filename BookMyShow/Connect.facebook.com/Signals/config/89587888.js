                    ...
                    function i(e) {
                        ...
                        if (i == null)
                            return {
                                formFieldFeatures: k,
                                userData: l,
                                rawCensoredUserData: m
                            };
                        i = i.querySelectorAll(g);
                        for (var n = 0; n < i.length; n++) {
                            ...
                            if (o instanceof HTMLInputElement || o instanceof HTMLTextAreaElement || o instanceof HTMLSelectElement || o instanceof HTMLButtonElement) {
                                var p = "" + o.tagName + (o.type === void 0 ? "" : o.type);
                                p = j.incrementAndGet(p);
                                if (p > d || o === f)
                                    continue;
                                p = c(o, e && l != null);
                                o = h(p, 3);
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.inferredevents", function() {
            return function(g, b, c, d) {
                ...
                (function() {
                    ...
                    var o = d.signalsConvertNodeToHTMLElement
                      , p = d.signalsExtractForm
                      , q = d.signalsIsIWLElement
                      , r = d.signalsExtractButtonFeatures
                      , s = d.signalsGetTruncatedButtonText
                      , t = d.signalsGetWrappingButton;
                    ...
                    var u = f.getFbeventsModules("SignalsFBEventsThrottler")
                      ...
                      , z = v.each
                      , A = v.keys
                      , B = f.getFbeventsModules("signalsFBEventsExtractFromInputs")
                      , C = new u()
                      , D = f.getFbeventsModules("signalsFBEventsDoAutomaticMatching")
                      , E = 100;
                    function F(a, b) {
                    ...
                    function G(b) {
                        return function(d) {
                            if (b.disableAutoConfig)
                                return;
                            var e = d.target instanceof Node ? o(d.target) : null;
                            if (e != null) {
                                if (q(e))
                                    return;
                                if (!C.passesThrottle(e))
                                    return;
                                d = b.getOptedInPixels("InferredEvents");
                                z(d, function(d) {
                                    var f = c.get(d.id, "inferredEvents")
                                      , g = !1;
                                    ...
                                    if (f == null)
                                        return;
                                    var i = b.optIns.isOptedIn(d.id, "AutomaticMatching")
                                      , j = a.eval("sgw_auto_extract", d.id) && b.optIns.isOptedIn(d.id, "OpenBridge")
                                      , k = p(f)
                                      , l = r(f, k)
                                      , n = l ? l.innerText : null;
                                    n = y(n != null ? n : s(f)).safe;
                                    ...
                                    k == null && m.trigger(d);
                                    i && k != null && D(b, d, k, o || {});
                                    j && k != null && (d.sgwUserDataFormFields = k);
                                    if (g && (d.userDataFormFields == null || A(d.userDataFormFields).length === 0) && (d.sgwUserDataFormFields == null || A(d.sgwUserDataFormFields).length === 0))
                                        return;
                                    b.trackSingleSystem("automatic", d, "SubscribedButtonClick", n)
                                })
                            }
                        }
                    }
                    function H(a, c, d, e, f) {
                        if (a.disableAutoConfig)
                            return;
                        var g = a.optIns.isOptedIn(c.id, "InferredEvents");
                        if (!g)
                            return;
                        g = a.optIns.isOptedIn(c.id, "AutomaticMatching");
                        if (!g)
                            return;
                        g = d == null;
                        e = B({
                            button: e,
                            containerElement: g ? b : d,
                            shouldExtractUserData: !0
                        });
                        g = e.userData;
                        d = e.rawCensoredUserData;
                        g == null ? m.trigger(c) : D(a, c, g, d || {}, f)
                    }
                    v = function(a) {
                        j(b, a);
                        function b() {
                            ...
                            for (var f = arguments.length, g = Array(f), h = 0; h < f; h++)
                                g[h] = arguments[h];
                            return d = (e = (c = i(this, (a = b.__proto__ || Object.getPrototypeOf(b)).call.apply(a, [this].concat(g))),
                            c),
                            c.extractPII = H,
                            e),
                            i(c, d)
                    ...
                    e.exports = new v(function(a, c) {
                        l.listenOnce(function() {
                            var a = x(G(c));
                            b.addEventListener ? b.addEventListener("click", a, {
                                capture: !0,
                                once: !1,
                                passive: !0
                            }) : g.attachEvent("onclick", a)
                        }),
                        n.listen(function(a, b, d) {
                            return H(c, a, b, d)
                        })
                    }
                    )
    ...
    (function() {
        ...
        f.ensureModuleRegistered("SignalsFBEventsLocalStorageUtils", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsLocalStorageTypedef")
                      , b = f.getFbeventsModules("SignalsFBEventsTyped")
                      , c = b.coerce;
                    function d(a, b) {
                        g.localStorage.setItem(a, b)
                    }
                    function h(a) {
                        return g.localStorage.getItem(a)
                    }
                    function i(a) {
                        g.localStorage.removeItem(a)
                    }
                    function j() {
                        var b = null;
                        try {
                            b = c(g.localStorage, a)
                        } catch (a) {
                            return !1
                        }
                        return b == null ? !1 : !0
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.cookie", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var k = c.getCustomParameters
                      , l = c.getClickIDFromBrowserProperties
                      , m = c.setFBP;
                    c.setEventId;
                    var n = f.getFbeventsModules("SignalsFBEventsPixelCookie");
                    c = f.getFbeventsModules("SignalsFBEventsPlugin");
                    var o = f.getFbeventsModules("SignalsFBEventsURLUtil")
                      , p = o.getURLParameter;
                    o = f.getFbeventsModules("SignalsFBEventsFbcCombiner");
                    var q = o.combineFbcParamsFromUrl
                      , r = f.getFbeventsModules("signalsFBEventsShouldNotDropCookie");
                    o = f.getFbeventsModules("SignalsPixelCookieUtils");
                    var s = o.readPackedCookie
                      , t = o.writeNewCookie
                      , u = o.writeExistingCookie
                      , v = o.CLICK_ID_PARAMETER
                      , w = o.CLICKTHROUGH_COOKIE_NAME
                      , x = o.CLICKTHROUGH_COOKIE_PARAM
                      , y = o.DOMAIN_SCOPED_BROWSER_ID_COOKIE_NAME
                      , z = o.DOMAIN_SCOPED_BROWSER_ID_COOKIE_PARAM
                      , A = o.DEFAULT_FBC_PARAM_CONFIG
                      , B = o.DEFAULT_ENABLE_FBC_PARAM_SPLIT
                      , C = o.MULTI_CLICKTHROUGH_COOKIE_PARAM
                      , D = o.NINETY_DAYS_IN_MS;
                    o = f.getFbeventsModules("SignalsFBEventsLocalStorageUtils");
                    var E = o.getLocalStorageItem
                      , F = o.setLocalStorageItem
                      , G = o.isLocalStorageSupported;
                    o = f.getFbeventsModules("SignalsFBEventsLogging");
                    var H = o.logError
                      , I = f.getFbeventsModules("FeatureGate")
                      , J = "_fbleid";
                    ...
                    function N() {
                        var c = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : a.location.href
                          ...
                          , e = p(c, v);
                        (e == null || e.trim() == "") && (e = p(b.referrer, v));
                        (e == null || e.trim() == "") && (e = d);
                    ...
                    function O() {
                        var c = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : a.location.href
                          ...
                          , e = arguments[2]
                          , f = d;
                        (f == null || f.trim() == "") && (f = q(c, e),
                        (f == null || f.trim() == "") && (f = q(b.referrer, e)));
                    ...
                    function P(a, b) {
                        try {
                            ...
                            if (c.includes(a))
                                return c;
                            var d = Date.now();
                            d = typeof d === "number" ? d : new Date().getTime();
                            c = c.split(",").slice(0, b - 1).map(function(a) {
                                return n.unpack(a)
                            }).filter(function(a) {
                                return a != null && a.creationTime != null && d - a.creationTime < D
                            }).map(function(a) {
                                return a && a.pack()
                            }).filter(function(a) {
                                return a != null && a !== ""
                            ...
                            a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[Multi Fbc Error] Error in adding multi fbc: " + a.message),
                            H(a, "pixel", "cookie")
                        }
                    }
                    function Q() {
                    ...
                    o = function(a) {
                        ...
                        function b() {
                            ...
                            c),
                            c.dropOrRefreshClickIDCookie = N,
                            c.dropOrRefreshDomainScopedBrowserIDCookie = Q,
                            c.dropOrRefreshFbcCookie = O,
                            c.addToMultiFbcQueue = P,
                            e),
                            h(c, d)
                        }
                        return b
                    }(c);
                    e.exports = new o(function(b, c) {
                        var e = null;
                        l.listen(function(a) {
                            e = a
                        });
                        ...
                        d.listen(function(b) {
                            ...
                            if (b == null)
                                return;
                            var d = c.pluginConfig.get(b.id, "cookie");
                            d != null && d.fbcParamsConfig != null && (g = d.fbcParamsConfig);
                            h = d != null && d.enableFbcParamSplit != null ? d.enableFbcParamSplit : B;
                            d != null && d.maxMultiFbcQueueSize != null && (i = d.maxMultiFbcQueueSize,
                            j = i > 0);
                            if (r(b, c))
                                return;
                            d = N(a.location.href, e);
                            d != null && j && P(d.pack(), i)
                        });
                        function b() {
                            k.listen(function(b, d, f, k, l) {
                                if (r(b, c))
                                    return {};
                                f = {};
                                k = N(a.location.href, e);
                                l = O(a.location.href, e, g);
                                if (h && l) {
                                    var n = l.pack();
                                    f[x] = n;
                                    if (j) {
                                ...
                                if (I("offsite_clo_beta_event_id_coverage", Number(b.id)) && d !== "Lead") {
                                    l = s(J);
                                    l != null && l.payload != null && (f.oed = {
                                        event_id: l.payload
                                    })
                                }
                                return f
        ...
        f.ensureModuleRegistered("SignalsFBevents.plugins.automaticmatchingforpartnerintegrations", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    e.exports = new d(function(a, d) {
                        g.listen(function(a) {
                            if (a == null)
                                return;
                            var e = d.optIns.isOptedIn(a, "AutomaticMatching")
                              , f = d.optIns.isOptedIn(a, "AutomaticMatchingForPartnerIntegrations");
                            e = e && f;
                            if (!e)
                                return;
                            f = d.getPixel(a);
                            if (f == null)
                                return;
                            e = c.get(f.id, "automaticMatching");
                            if (e == null)
                                return;
                            a = p(e.selectedMatchKeys);
                            if (a == null || k(a))
                                return;
                            f.userDataFormFields = b({}, f.userDataFormFields, a);
                            h.trigger(f)
                        })
                    }
                    )
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var i = f.getFbeventsModules("signalsFBEventsGetIsIosInAppBrowser")
                      ...
                      , l = f.getFbeventsModules("SignalsFBEventsGuardrail")
                    ...
                    e.exports = new c(function(c, e) {
                        ...
                        g.listen(function(b, c) {
                            if (!p(b))
                                return;
                            var d = a.location.origin + "_" + Date.now() + "_" + Math.random();
                            d = m(d);
                            var e = c.get("eid");
                            l.eval("multi_eid_fix", b) && (e == null || e === "") && (e = c.getEventId());
                            if (e != null && e !== "" || d == null)
                                return;
                            c.append("apcm_eid", "1");
                            b = "pcm_plugin-set_" + d;
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.browserproperties", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var c = a.getClickIDFromBrowserProperties
                    ...
                    var i = f.getFbeventsModules("signalsFBEventsSendEvent");
                    i.sendEvent;
                    var j = f.getFbeventsModules("signalsFBEventsShouldNotDropCookie");
                    i = f.getFbeventsModules("SignalsFBEventsURLUtil");
                    i.getURLParameter;
                    var k = i.maybeGetParamFromUrlForEbp
                      , l = f.getFbeventsModules("SignalsParamList");
                    i = f.getFbeventsModules("SignalsFBEventsBrowserPropertiesTypedef");
                    var m = i.XMLHttpRequestPrototypeTypedef;
                    i = f.getFbeventsModules("SignalsFBEventsTyped");
                    var n = i.coerce;
                    i = f.getFbeventsModules("SignalsFBEventsFbcCombiner");
                    var o = i.combineFbcParamsFromUrlAndEBP;
                    i = f.getFbeventsModules("SignalsPixelCookieUtils");
                    var p = i.CLICK_ID_PARAMETER
                      , q = i.CLICKTHROUGH_COOKIE_PARAM;
                    i = f.getFbeventsModules("SignalsFBEvents.plugins.cookie");
                    var r = i.dropOrRefreshClickIDCookie
                      , s = i.dropOrRefreshFbcCookie;
                    i = [{
                        prefix: "",
                        query: "fbclid",
                        ebp_path: "clickID"
                    ...
                    function z(a, b, d) {
                        ...
                        if (e == null || a == null)
                            return;
                        e = d.getPixel(e.toString());
                        if (e == null)
                            return;
                        e = j(e, d);
                        if (e)
                            return;
                        d = b.customParams || new l();
                        e = d.get(q);
                        if (!v) {
                            if (e != null && e !== "")
                                return;
                            var f = r(g.location.href, a);
                            f != null && (d.append(q, f.pack()),
                            b.customParams = d)
                        } else {
                            f = s(g.location.href, a, u);
                            f != null && (e == null || e === "" ? d.append(q, f.pack()) : d.replaceEntry(q, f.pack()),
                            b.customParams = d)
                        }
                    }
                    function A(a) {
                        var b = new Promise(function(b, c) {
                            var d = new g.XMLHttpRequest();
                            d.onloadend = function() {
                                if (d.readyState === d.DONE && d.status >= 200 && d.status < 300) {
                                    var e = a.asyncParamFetchers.get(w);
                                    e != null && e.result == null && (e.result = d.responseText,
                                    a.asyncParamFetchers.set(w, e));
                                    b(d.responseText)
                                } else {
                                    e = new Error("[EBP Error] Android, status=" + d.status + ", responseText=" + d.responseText);
                                    h(e, x, y);
                                    c(e)
                                }
                            }
                            ;
                            try {
                                var e = n(XMLHttpRequest.prototype, m);
                                if (e != null && !e.open.toString().includes("native code")) {
                                    e = new Error("[EBP Error] XMLHttpRequest.prototype.open is overridden ");
                                    h(e, x, y);
                                    c(e)
                                }
                                d.open("GET", "properties://browser/clickID");
                                d.send()
                            } catch (a) {
                                e = new Error("[EBP Error] XMLHttpRequest.prototype.open call failed");
                                h(e, x, y);
                                c(e)
                            }
                        }
                        );
                        a.asyncParamFetchers.set(w, {
                            request: b,
                            callback: z
                        });
                        a.asyncParamPromisesAllSettled = !1
                    }
                    function B(a, b, c) {
                        var d = new Promise(function(a, d) {
                            ...
                            b.forEach(function(a) {
                                ...
                                var c = new Promise(function(c, d) {
                                    var f = new g.XMLHttpRequest();
                                    f.onloadend = function() {
                                        if (f.readyState === f.DONE && f.status >= 200 && f.status < 300)
                                            e.push({
                                                paramConfig: a,
                                                paramValue: f.responseText
                                            }),
                                            c(f.responseText);
                                        else {
                                            var b = new Error("[EBP Error], status=" + f.status + ", responseText=" + f.responseText);
                                            h(b, x, y);
                                            d(b)
                                        }
                                    }
                                    ;
                                    try {
                                        var i = n(XMLHttpRequest.prototype, m);
                                        if (i != null && !i.open.toString().includes("native code")) {
                                            i = new Error("[EBP Error] XMLHttpRequest.prototype.open is overridden ");
                                            h(i, x, y);
                                            d(i)
                                        }
                                    } catch (a) {
                                    ...
                                    f.open("GET", "properties://browser/" + b);
                                    f.send()
                                }
                                );
                                f.push(c)
                    ...
                    function C(a) {
                        ...
                        b.then(function(b) {
                            var c = a.asyncParamFetchers.get(w);
                            c != null && c.result == null && (c.result = b,
                            a.asyncParamFetchers.set(w, c));
                            return b
                        })["catch"](function(a) {
                            a.message = "[EBP Error] Fetch error" + a.message,
                            h(a, x, y)
                        });
                        a.asyncParamFetchers.set(w, {
                            request: b,
                    ...
                    function D(a, b, c) {
                        var d = []
                          , e = []
                          , f = new Promise(function(f, i) {
                            b.forEach(function(a) {
                                var b = a.ebp_path;
                                if (b === "")
                                    return;
                                b = g.webkit.messageHandlers.browserProperties.postMessage(b);
                                b.then(function(b) {
                                    d.push({
                                        paramConfig: a,
                                        paramValue: b
                            ...
                            Promise.allSettled(e).then(function(b) {
                                b = o(c, d);
                                var e = a.asyncParamFetchers.get(w);
                                e != null && e.result == null && (e.result = b,
                                a.asyncParamFetchers.set(w, e));
                                f(b)
                            })
                        }
                    ...
                    e.exports = new a(function(a, c) {
                        if (typeof Promise === "undefined" || Promise.toString().indexOf("[native code]") === -1)
                            return;
                        var e = g.webkit != null && g.webkit.messageHandlers != null && g.webkit.messageHandlers.browserProperties != null
                          , h = d(397, 264) && typeof g.XMLHttpRequest !== "undefined";
                        if (!e && !h)
                            return;
                        var i = []
                          , j = [];
                        b.listen(function(a) {
                            ...
                            if (a == null)
                                return;
                            a = c.pluginConfig.get(a.id, "browserProperties");
                            a != null && a.fbcParamsConfig != null && (u = a.fbcParamsConfig);
                            v = a != null && a.enableFbcParamSplit != null ? a.enableFbcParamSplit : t;
                            if (!v) {
                                if (k(p) != null)
                                    return
                            } else if (u.params != null) {
                                u.params.forEach(function(a) {
                                    var b = k(a.query);
                                    b != null ? j.push({
                                        paramConfig: a,
                                        paramValue: b
                            ...
                            new Map();
                            e && !v ? C(c) : e && v ? D(c, i, j) : h && !v ? A(c) : h && v && B(c, i, j)
                        })
                    }
                    )
                }
                ...
                (function() {
                    ...
                    e.exports = new d(function(d, e) {
                        ...
                        try {
                            ...
                            k(a, "pixel", "lastexternalreferrer")
                        }
                    }
                    )
                }
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var d = f.getFbeventsModules("SignalsParamList")
                      ...
                      , j = "cdl"
                      , k = "cookieDeprecationLabel";
                    g = "";
                    function l(a, b, c) {
                        c = b.customParams || new d();
                        c.get(j) == null && a != null && c.append(j, String(a));
                        b.customParams = c
                    }
                    e.exports = new b(function(b, d) {
                        ...
                        b = b.getValue().then(function(a) {
                            if (a == null)
                                return null;
                            g = String(a);
                            a = d.asyncParamFetchers.get(k);
                            a != null && a.result == null && (a.result = g,
                            d.asyncParamFetchers.set(k, a));
                            return g
                        })["catch"](function(a) {
                            a.message = "[CookieDeprecationLabel Error] Fetch error" + String(a.message),
                            h(a, "pixel", "cookiedeprecationlabel")
                        });
                        d.asyncParamFetchers.set(k, {
                            request: b,
                            callback: l
                        });
                        d.asyncParamPromisesAllSettled = !1
                    }
                    )
                }
                )();
...
(function(a, b, c, d) {
    ...
    (function() {
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var c = f.getFbeventsModules("SignalsFBEventsNetworkConfig")
                      , d = f.getFbeventsModules("SignalsFBEventsFiredEvent");
                    f.getFbeventsModules("SignalsParamList");
                    var g = f.getFbeventsModules("SignalsFBEventsLocalStorageUtils")
                      , h = g.getLocalStorageItem
                      , i = g.setLocalStorageItem
                      , j = g.isLocalStorageSupported;
                    g = f.getFbeventsModules("SignalsFBEventsLogging");
                    var k = g.logError
                      , l = g.logWarning
                      , m = f.getFbeventsModules("signalsFBEventsGetIsChrome")
                      , n = f.getFbeventsModules("signalsFBEventsGetIsMicrosoftEdge")
                      , o = f.getFbeventsModules("signalsFBEventsGetIsAndroidIAW");
                    g = f.getFbeventsModules("SignalsFBEventsPlugin");
                    var p = "topicsLastReferenceTime"
                      , q = 24 * 60 * 60 * 1e3
                      , r = 1
                      , s = "pixel"
                      , t = "topicsapi"
                      , u = function(a) {
                        return "[Topics API][Pixel Plugin] " + a
                    }
                      , v = function(a) {
                      ...
                      , w = function() {
                        ...
                        try {
                            ...
                            b = "preObservationAction action:" + (a == null ? "Unknown" : a.message);
                            l(new Error(u(b)), s, t);
                            return !1
                        }
                        return a
                      ...
                      , x = function() {
                        ...
                        try {
                            ...
                            var a = "postObservationAction action:" + (b == null ? "Unknown" : b.message);
                            l(new Error(u(a)), s, t)
                        }
                    }
                      , y = function(b) {
                        var d = c.TOPICS_API_ENDPOINT;
                        d = d + "?id=" + b;
                        a.fetch(d, {
                            browsingTopics: !0,
                            skipObservation: !0
                        })["catch"](function(a) {
                            a = "observation action:" + (a == null ? "Unknown" : a.message);
                            l(new Error(u(a)), s, t)
                        })
                    };
                    g = new g(function(a, c) {
                        if (!(m() || o() || n()))
                            return;
                        if (b.featurePolicy == null || !b.featurePolicy.allowsFeature("browsing-topics"))
                            return;
                        d.listen(function(a, b) {
                            try {
                                ...
                                if (a) {
                                    a = b.get("id");
                                    if (a == null) {
                                        k(new Error(u("no pixel id found")), s, t);
                                        return
                                    }
                                    y(a)
                                }
                                ...
                                b = "generic client-side:" + (a == null ? "Unknown" : a.message);
                                l(new Error(u(b)), s, t)
                            }
                        })
                    }
        ...
        e.exports = f.getFbeventsModules("SignalsFBEvents.plugins.topicsapi");
        f.registerPlugin && f.registerPlugin("fbevents.plugins.topicsapi", e.exports);
...
fbq.registerPlugin("895788993886590", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        config.set("895788993886590", "inferredEvents", {
            "buttonSelector": null,
            "disableRestrictedData": false
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("895788993886590", "InferredEvents", true);
        config.set("895788993886590", "automaticMatching", {
            "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("895788993886590", "AutomaticMatching", true);
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("895788993886590", "IWLBootstrapper", true);
        config.set("895788993886590", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
            ...
            "maxMultiFbcQueueSize": 5
        });
        fbq.loadPlugin("cookie");
        instance.optIn("895788993886590", "FirstPartyCookies", true);
        fbq.loadPlugin("inferredevents");
        instance.optIn("895788993886590", "InferredEvents", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("895788993886590", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("895788993886590", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("895788993886590", "ProhibitedSources", true);
        config.set("895788993886590", "unwantedData", {
            "blacklisted_keys": {
                "PageView": {
                    "cd": [],
                    "url": ["uemail", "uaw", "first_name", "lat", "lng", "af_ip", "q", "guestpassid"]
                },
                "ViewContent": {
                    "cd": [],
                    "url": ["lat"]
        ...
        instance.optIn("895788993886590", "UnwantedData", true);
        config.set("895788993886590", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("895788993886590", "IABPCMAEBridge", true);
        config.set("895788993886590", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("895788993886590", "BrowserProperties", true);
        config.set("895788993886590", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("895788993886590", "EventValidation", true);
        config.set("895788993886590", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("895788993886590", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("895788993886590", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("895788993886590", "CookieDeprecationLabel", true);
        fbq.loadPlugin("unwantedparams");
        instance.optIn("895788993886590", "UnwantedParams", true);
        instance.optIn("895788993886590", "ShadowTest", true);
        fbq.loadPlugin("standardparamchecks");
        instance.optIn("895788993886590", "StandardParamChecks", true);
        fbq.loadPlugin("topicsapi");
        instance.optIn("895788993886590", "TopicsAPI", true);
        config.set("895788993886590", "gating", {
            "gatings": [{
                ...
                "name": "enable_product_variant_id",
                "passed": false
            }]
        });
        fbq.loadPlugin("gating");
        instance.optIn("895788993886590", "Gating", true);
        instance.configLoaded("895788993886590");
    }
});
